...
sudoku_medium_train_path=$DATA_DIR/sudoku_medium_qwen_2w/train.parquet
sudoku_medium_test_path=$DATA_DIR/sudoku_medium_qwen_2w/test.parquet
sudoku_hard_train_path=$DATA_DIR/sudoku_hard_qwen_3w/train.parquet
sudoku_hard_test_path=$DATA_DIR/sudoku_hard_qwen_3w/test.parquet
...
BASE_MODEL_NAME=Qwen2.5-14B-Instruct-1M
export BASE_MODEL=${WORK_DIR}/Qwen/${BASE_MODEL_NAME}
...
### model:14b,max_response_length:8192,train/val_batch:16 =>ok
...
#model_parallel_size:4,gpu_memory_utilization=0.6
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:14b,max_response_length:8192,train/val_batch:32 =>no
...
#model_parallel_size:4,gpu_memory_utilization=0.6
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:14b,max_response_length:8192,train/val_batch:16 => no
