...
BASE_MODEL=${WORK_DIR}/deepseek-ai/${BASE_MODEL_NAME}
...
### model:32b,max_response_length:8192,train/val_batch:16 =>no
### model:32b,max_response_length:4096,train/val_batch:16 =>no

#model_parallel_size:8,gpu_memory_utilization=0.6
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:32b,max_response_length:8192,train/val_batch:8 =>no
### model:32b,max_response_length:4096,train/val_batch:8 =>no


#model_parallel_size:8,gpu_memory_utilization=0.4
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:32b,max_response_length:8192,train/val_batch:8 =>no
### model:32b,max_response_length:4096,train/val_batch:8 =>no
...
#model_parallel_size:8,gpu_memory_utilization=0.4
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:32b,max_response_length:8192,train/val_batch:4 =>error
### model:32b,max_response_length:4096,train/val_batch:4 =>error


#model_parallel_size:8,gpu_memory_utilization=0.4
#enable_gradient_checkpointing:True,ref.fsdp_config.param_offload:True
### model:32b,max_response_length:2048,train/val_batch:8 =>no,step1后oom
### model:32b,max_response_length:1024,train/val_batch:8 =>no,step6后oom
